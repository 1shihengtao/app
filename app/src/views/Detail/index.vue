          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{ active: spuSaleAttrValue.isChecked == 1 }" v-for="spuSaleAttrValue in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id" @click="changeActive(spuSaleAttrValue, spuSaleAttr.spuSaleAttrValueList)">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <!-- 点击商品减一 -->
                <a class="mins" @click="skuNum > 1 ? skuNum-- : (skyNum = 1)">-</a>
              </div>
              <div class="add">
